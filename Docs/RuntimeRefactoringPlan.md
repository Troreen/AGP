...
> Historical snapshot: this plan is superseded by the implemented GameApplication architecture in [GameFrameworkRefactoringPlan.md](GameFrameworkRefactoringPlan.md) and the current architecture docs.

Status: superseded. Retained for historical context; its runtime descriptions and migration steps do not describe the current source.
