...
public:
	...
	MaterialDomain GetDomain() const override
	{
		return myDescription.Domain;
	}

	ShadingModel GetShadingModel() const override
	{
		return myDescription.ShadingModel;
	}

	BlendMode GetBlendMode() const override
	{
		return myDescription.BlendMode;
	}

	const PipelineStateObject& GetPSO() const override
	{
		return myPSO;
	}

	const PipelineStateObject& GetGBufferPSO() const override
	{
		return myGBufferPSO;
	}

	const uint8_t* GetParameterDataBlock() const override
	{
		return myData;
	}
	...
	{
		return !myParameters.empty();
	}

	const std::vector<MaterialParameterInfo>& GetParameters() const override
	{
		return myParameters;
	}
...
public:
	...
	MaterialDomain GetDomain() const override
	{
		return myParentMaterial->GetDomain();
	}

	ShadingModel GetShadingModel() const override
	{
		return myParentMaterial->GetShadingModel();
	}

	BlendMode GetBlendMode() const override
	{
		return myParentMaterial->GetBlendMode();
	}

	const PipelineStateObject& GetPSO() const override
	{
		return myParentMaterial->GetPSO();
	}

	const PipelineStateObject& GetGBufferPSO() const override
	{
		return myParentMaterial->GetGBufferPSO();
	}
	...
	bool HasParameters() const override
	{
		return myParentMaterial->HasParameters();
	}

	const std::vector<MaterialParameterInfo>& GetParameters() const override
	{
		return myParentMaterial->GetParameters();
	}
	...
	const MaterialParameterInfo* GetParameterByIndex(unsigned aIndex) const override
	{
		return myParentMaterial->GetParameterByIndex(aIndex);
	}

	const MaterialParameterInfo* GetParameterByName(const std::string& aName) const override
	{
		return myParentMaterial->GetParameterByName(aName);
	}

	template <typename T> bool SetValue(const std::string& aLabel, const T& aValue)
	{
