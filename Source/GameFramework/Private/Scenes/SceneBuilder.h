...
public:
	...
	{
		return Candidate != nullptr && Diagnostics.empty();
	}
};
...
public:
	...
	static SceneBuildResult Build(const SceneData& scene, const ComponentRegistry& registry, const SceneBuildServices& services = {});
};
