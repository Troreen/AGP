...
enum class ReferenceRequirement { Required, Optional };
...
private:
    ...
    SceneReader(const ComponentRecord& record, SceneDiagnostic source, SceneDiagnostics& diagnostics,
    ...
    void Bind(const std::string& field, bool component, ReferenceRequirement requirement,
