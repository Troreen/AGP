...
public:
	...
	// TODO: is accessing actors by string name really the best way? A UUID might be a better apprach.
...
private:
	...
	bool AcceptsChanges() const
	{
		return !myClosing && myState != State::Ending;
	}
