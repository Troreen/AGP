...
public:
    ...
    CommonUtilities::Vector3f GetLocalForward() const { return myValue.GetForward(); }
    CommonUtilities::Vector3f GetLocalRight() const { return myValue.GetRight(); }
    CommonUtilities::Vector3f GetLocalUp() const { return myValue.GetUp(); }
private:
