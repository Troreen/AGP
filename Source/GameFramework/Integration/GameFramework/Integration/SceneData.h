...
using PropertyValue = std::variant<bool, int64_t, double, std::string, CommonUtilities::Vector3f, CommonUtilities::Quaternion<float>,
                                   CommonUtilities::Vector4f, AssetId, std::vector<AssetId>, ObjectAddress>;
